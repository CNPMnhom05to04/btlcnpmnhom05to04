...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::commit();
            return redirect('admin/products/create')->with('msgSuccess', 'Thêm chi tiết sân thành công');
        }
        catch (\Exception $e) {
            DB::rollBack();
            return redirect('admin/products/create')->with('msgSuccess', 'Thêm chi tiết sân thất bại');
        }
    }

    //Xem chi tiết chi tiết sân
    ...
    public function update(ProductUpdateRequest $request, $id)
    {
        try {
            ...
            DB::commit();
            return redirect()->back()->with('msgSuccess', 'Sửa chi tiết sân thành công');
        }
        catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->with('msgSuccess', 'Sửa chi tiết sân thất bại');
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $data->delete();
            DB::commit();
            return response()->json(['msgSuccess'=>'Xóa chi tiết sân thành công']);
        }
        catch (\Exception $e) {
            DB::rollBack();
            return response()->json(['msgError'=>'Xóa chi tiết sân thất bại']);
        }
    }
}
