...
Route::get('location/{id}', [PageController::class, 'brand']);
...
Route::post('/order-stadium', [\App\Http\Controllers\frontend\RequirementController::class, 'storeOrderStadium']);
Route::get('/statidum', [\App\Http\Controllers\frontend\RequirementController::class, 'getStadium'])->name('getStadium');
